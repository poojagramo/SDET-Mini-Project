...
public class MonthlyCollectionTestCase extends BrowserSetup {
    ...
    public void ViewMonthlyCollection() {
        try {
            test1 = extent.createTest("Monthly Fee Collection - Management Login", "Test to validate Monthly Fee Collection Card Functinality");
            ...
            //verify card present
            managementDashboard.MonthlyFeeCardPresent();
            test1.pass("Monthly Fee Collection Card is Present ");
            //open view static heads card
            managementDashboard.clickMonthlyFeeCollectionViewTheLink();
            test1.pass("Monthly Fee Collection Card is Clicked ");
            //verify title of view flexible heads
            managementDashboard.verifyTitleOfMonthlyFeeCollection();
            test1.pass("Monthly Fee Collection Card Title is Correct ");
            //verify the table is present
            managementDashboard.verifyTableViewMonthlyFee();
            test1.pass("Monthly Fee Collection Table is Present ");
            //signout
