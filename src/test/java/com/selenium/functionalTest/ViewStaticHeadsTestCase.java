...
public class ViewStaticHeadsTestCase extends BrowserSetup {
    ...
    @Test
    public void ViewStaticHeads() {
        try {
            test1 = extent.createTest("View Static Heads - Management Login", "Test to validate View Static Heads Card Functinality");
            ...
            //verify card present
            managementDashboard.viewStaticHeadsCardPresent();
            test1.pass("View Static Heads Card is Present ");
            //open view static heads card
            managementDashboard.clickViewStaticHeadsViewDifferentLink();
            test1.pass("View Static Heads Card is Clicked ");
            //verify title of view static heads
            managementDashboard.verifyTitleOfViewStaticHeads();
            test1.pass("View Static Heads Card Title is Correct ");
            //verify the table is present
            managementDashboard.verifyAllTablesColumn();
            test1.pass(" Static Heads Table is Present ");
